...
public class AsyncBeanManager {
  /**
    ...
    * @return
    *        <tt>true</tt> if the {@link org.jboss.errai.ioc.client.container.DestructionCallback} is successfully registered against a valid
