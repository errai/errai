...
Another way to start a new project with Errai is to use Forge and the Errai Forge Addon. To use this method, follow the instructions link:$$https://github.com/errai/forge-errai/blob/v2.0.0.Beta1/README.asciidoc$$[here] to install the Errai Forge Addon and create a new project.
