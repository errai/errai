 ...
 * {@link jakarta.enterprise.context.spi.Context#get(Contextual, CreationalContext)}
 * operation of the context object for the <tt>@Dependent</tt> scope
 * returns a new instance of the given bean.</p>
 *
 * <p>Every invocation of the
 * {@link jakarta.enterprise.context.spi.Context#get(Contextual)}
 * operation of the context object for the <tt>@Dependent</tt> scope
 ...
 * direct invocation of an {@link jakarta.enterprise.inject.Instance} is
 * a dependent object of the instance of
 * {@link jakarta.enterprise.inject.Instance}.</li>
 * </ul>
 *
