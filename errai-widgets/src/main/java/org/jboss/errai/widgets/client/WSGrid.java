...
public class WSGrid extends org.gwt.mosaic.ui.client.layout.LayoutPanel {
  private static final int CELL_HEIGHT_PX = 18;

  //private FocusPanel focusPanel;
  private org.gwt.mosaic.ui.client.layout.LayoutPanel innerPanel;
  ...
  public WSGrid(boolean scrollable, boolean editable)
  {
    ...
    innerPanel = new org.gwt.mosaic.ui.client.layout.LayoutPanel(
        new BoxLayout(BoxLayout.Orientation.VERTICAL)
    );
    innerPanel.setPadding(0);
    this.add(innerPanel);
    ...
    innerPanel.add(titleBar, new BoxLayoutData(BoxLayoutData.FillStyle.HORIZONTAL));
    ...
    innerPanel.add(dataGrid, new BoxLayoutData(BoxLayoutData.FillStyle.BOTH));
 ...
 focusPanel.addMouseOutHandler(new MouseOutHandler() {
  ...
  public class WSAbstractGrid extends Composite {
    private ScrollLayoutPanel scrollPanel;
    ...
    public WSAbstractGrid(boolean scrollable, GridType type) {
      ...
      scrollPanel = new ScrollLayoutPanel();
    ...
    public ScrollLayoutPanel getScrollPanel() {
      return scrollPanel;
    }
