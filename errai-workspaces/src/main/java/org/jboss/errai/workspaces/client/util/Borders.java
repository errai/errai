...
public class Borders {
    ...
    $wnd.RUZEE.ShadedBorder.create({corner:radius,
        edges:@org.jboss.errai.workspaces.client.util.Borders::convertWhere(I)(edges)}).render(elem);
     }-*/;
    ...
    public static native String convertWhere(int where) /*-{
      var result = "";
      if (where & @org.jboss.errai.workspaces.client.util.Borders::LEFT) {
        result += "l";
      }
      if (where & @org.jboss.errai.workspaces.client.util.Borders::TOP) {
        result += "t";
      }
      if (where & @org.jboss.errai.workspaces.client.util.Borders::RIGHT) {
        result += "r";
      }
      if (where & @org.jboss.errai.workspaces.client.util.Borders::BOTTOM) {
        result += "b";
      }
      return result;
    }-*/;
