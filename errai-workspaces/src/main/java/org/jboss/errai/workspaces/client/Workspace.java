...
public class Workspace extends DeckLayoutPanel
{
  ...
  public void showToolSet(final String toolSetId, final String toolId)
  {
    ...
    {
      TabWrapper wrapper = new TabWrapper(selectedTool.getId(), selectedTool.getWidget());
      wrapper.invalidate();
      deck.tabLayout.add(
          wrapper,
  ...
  private class ToolSetDeck extends LayoutPanel
  {
    ToolSet toolSet;
    int index;
  ...
  class TabWrapper extends LayoutPanel
  {
    String id;
