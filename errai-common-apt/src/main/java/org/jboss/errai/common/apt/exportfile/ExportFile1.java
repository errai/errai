 ...
 */
public class ExportFile1 implements ExportFile {
  ...
  public ExportFile1(final String erraiModuleNamespace, final TypeElement annotation, final Set<TypeMirror> exportedTypes) {
