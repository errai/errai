 ...
 */
public class ExportFile2 implements ExportFile {

  private final ExportedTypesFromSource exportedTypesFromSource;
  private final String erraiModuleNamespace;
  private final String simpleClassName;

  public ExportFile2(final String erraiModuleNamespace, final ExportedTypesFromSource exportedTypesFromSource) {
