...
public class ErraiJpaAttributeAccessorTest extends GWTTestCase {
  ...
  public void testReadBoxedTypes() throws Exception {
  ...
  public void testWriteBoxedTypes() throws Exception {
    JpaAttributeAccessor a = getAttributeAccessor();
    EntityManager em = getEntityManager();
    EntityType<Zentity> metaZentity = em.getMetamodel().entity(Zentity.class);
  ...
  public void testReadNullBoxedTypes() throws Exception {
    Zentity zentity = new Zentity();
  ...
  public void testWritePrimitiveTypes() throws Exception {
    JpaAttributeAccessor a = getAttributeAccessor();
    EntityManager em = getEntityManager();
    EntityType<Zentity> metaZentity = em.getMetamodel().entity(Zentity.class);
  ...
  public void testReadObjectTypes() throws Exception {
    Zentity zentity = new Zentity();
