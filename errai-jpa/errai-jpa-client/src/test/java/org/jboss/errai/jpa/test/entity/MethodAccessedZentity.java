...
/**
 * This is a copy of the Zen Entity, that uses getter/setter access instead of direct field access.
 *
 * @author Jonathan Fuerth <jfuerth@gmail.com>
 */
@SuppressWarnings("JpaQlInspection")
@TestOnly @Entity
public class MethodAccessedZentity {
   ...
   */
  public MethodAccessedZentity(boolean primitiveBool, Boolean boxedBool, byte primitiveByte,
  ...
  public String toString() {
    return "MethodAccessedZentity [id=" + id + ", primitiveBool=" + primitiveBool
