...
=== Installing Forge 2.4.1.Final

===== 1. Download link:$$https://repository.jboss.org/nexus/service/local/artifact/maven/redirect?r=releases&g=org.jboss.forge&a=forge-distribution&v=2.4.1.Final&e=zip&c=offline$$[Forge 2.4.1.Final]

.. Download the zip file for Forge 2.4.1.Final in the link above.
...
[code]
----
PATH=$PATH:$HOME/forge-distribution-2.4.1.Final/bin
----
