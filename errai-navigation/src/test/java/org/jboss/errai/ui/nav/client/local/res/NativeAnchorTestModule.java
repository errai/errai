...
import org.jboss.errai.ui.nav.client.local.testpages.SomeUniquePageRole;
 ...
 */
@Dependent
public class NativeAnchorTestModule {

  @Inject @TransitionTo(PageB.class)
  public Anchor pageB;

  @Inject @TransitionToRole(SomeUniquePageRole.class)
  public Anchor uniqueRole;
