...
public class ServerSQLDateMarshaller extends AbstractSQLDateMarshaller<Map> {

  @Override
  public java.sql.Date demarshall(Map o, MarshallingSession ctx) {
    return new java.sql.Date(Long.parseLong(String.valueOf(o.get(SerializationParts.VALUE))));
  }
