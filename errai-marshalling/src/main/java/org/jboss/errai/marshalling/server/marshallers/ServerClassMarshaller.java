 ...
 */
@ServerMarshaller(Class.class)
public class ServerClassMarshaller extends AbstractNullableMarshaller<Class<?>> {
  @Override
  ...
  public final Class<?> demarshall(final Class<?> targetType, final EJValue o, final MarshallingSession ctx) {
    ...
    return ServerMarshalling.getMarshaller(className.isString().stringValue())
