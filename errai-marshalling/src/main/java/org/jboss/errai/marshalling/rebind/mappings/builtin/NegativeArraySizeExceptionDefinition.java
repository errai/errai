 ...
 */
@CustomMapping
public class NegativeArraySizeExceptionDefinition extends MappingDefinition {
  public NegativeArraySizeExceptionDefinition() {
    super(NegativeArraySizeException.class);
