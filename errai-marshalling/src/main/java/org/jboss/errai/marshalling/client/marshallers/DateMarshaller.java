...
public class DateMarshaller implements Marshaller<JSONValue, Date> {
  @Override
  ...
  public Date demarshall(JSONValue o, MarshallingSession ctx) {
    return new Date(Long.parseLong(o.isObject().get(SerializationParts.VALUE).isNumber().toString()));
  }
