 ...
 */
@ServerMarshaller
public class ServerIntegerMarshaller extends AbstractNumberMarshaller<Object, Integer> {
  @Override
  ...
  @Override
  public Integer demarshall(Object o, MarshallingSession ctx) {
    if (o instanceof Map) {
      return ((Double) ((Map) o).get(SerializationParts.NUMERIC_VALUE)).intValue();
    }
    else {
      return (Integer) o;
    }
