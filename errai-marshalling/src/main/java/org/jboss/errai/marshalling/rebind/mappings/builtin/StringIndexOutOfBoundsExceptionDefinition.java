 ...
 */
@CustomMapping
public class StringIndexOutOfBoundsExceptionDefinition extends MappingDefinition {
  public StringIndexOutOfBoundsExceptionDefinition() {
    super(StringIndexOutOfBoundsException.class);
