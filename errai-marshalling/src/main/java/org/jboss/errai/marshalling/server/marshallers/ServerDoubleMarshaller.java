 ...
 */
@ServerMarshaller
public class ServerDoubleMarshaller extends AbstractNumberMarshaller<Object, Double> {
  @Override
  ...
  @Override
  public Double demarshall(Object o, MarshallingSession ctx) {
    if (o instanceof Map) {
      return (Double) ((Map) o).get(SerializationParts.NUMERIC_VALUE);
    }
    else {
      return (Double) o;
    }
