 ...
 */
@CustomMapping
public class UnsupportedEncodingExceptionDefinition extends MappingDefinition {
  public UnsupportedEncodingExceptionDefinition() {
    super(UnsupportedEncodingException.class);
