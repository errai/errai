...
public interface WebSocketFilter {
	 ...
	 *
	 * @param websocketSession actual websocket session
	 * @param httpSession actual http session
	 * @param sharedProperties map of user defined properties, they are kept alive during before and after filter method invocation of all filters.
	 * @param message unaltered Errai message from the websocket text frame
	 */
