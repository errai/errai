...
public class FilterDelegate {
   ...
   * @param message
   */
  public static void invokeFilterBefore(Session websocketSession, HttpSession httpSession, Map<Object, Object> sharedProperties,
										String message) {
	 ...
	 * @param message
	 */
  public static void invokeFilterAfter(Session websocketSession, HttpSession httpSession, Map<Object, Object> sharedProperties,
									   String message) {
    final List<WebSocketFilter> filters = FilterLookup.getInstance()
            .getFilters();
    if (filters != null) {
