...
public class FraudClient extends LayoutPanel {
    ...
    private TextArea responsePanel;
    ...
    public FraudClient() {
        ...
        Button button = new Button("Create activity", new ClickHandler() {
            public void onClick(ClickEvent clickEvent) {
                responsePanel.setText(responsePanel.getText()+"\n--\n");
                event.fire(new AccountActivity());
            }
        });

        responsePanel = new TextArea();
        responsePanel.setCharacterWidth(80);
        responsePanel.setVisibleLines(20);        
    ...
    public void processFraud(@Observes Fraud fraudEvent) {
        StringBuffer sb = new StringBuffer(responsePanel.getText());
        sb.append("Fraud detected: " + fraudEvent.getTimestamp());
        sb.append("\n");
        responsePanel.setText(sb.toString());
    }   
}
