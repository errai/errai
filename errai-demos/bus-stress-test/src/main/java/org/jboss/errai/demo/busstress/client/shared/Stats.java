...
public class Stats {
  ...
  /**
   * Returns the mean time between sending a request and receiving the reply, in
  ...
  /**
   * Returns the total amount of time this stats has been running for. If this
   * stats is still running, returns the time from {@link #startTime} until now;
   * if this stats is finished, returns the amount of time between
   * {@link #startTime} and {@link #finishTime}.
   *
