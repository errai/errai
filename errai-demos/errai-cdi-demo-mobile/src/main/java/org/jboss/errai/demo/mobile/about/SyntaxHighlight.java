...
public class SyntaxHighlight {
     ...
     *
     * @param f The file to get the relative path for. Must be under {@link #sourceBaseDir}.
     * @return The path of f relative to {@link #sourceBaseDir}.
     * @throws IllegalArgumentException If the given file is not to be found under sourceBaseDir.
     */
    ...
    /**
     * Returns the relative pathname from f to a stylesheet with the given name located in {@link #targetBaseDir}.
     *
     * @param f
