...
import org.jboss.errai.security.test.interceptor.client.local.res.CountingMessageCallback;
...
public class ServerBusSecurityInterceptorTest extends BusSecurityInterceptorTest {
  ...
  protected void gwtSetUp() throws Exception {
    super.gwtSetUp();
    counter = 0;
    errorSubscription = ErraiBus.get().subscribe(DefaultErrorCallback.CLIENT_ERROR_SUBJECT, message -> {
