 ...
 */
public class RestServiceUsingIfaceImpl implements RestServiceUsingIface {

  @Override
  public boolean doSomething(final IfaceWithPortableImpl obj) {
    return obj instanceof PortableImpl;
  }

  @Override
  public IfaceWithPortableImpl getSomething() {
