...
public class TestApplication extends Application {
    ...
    public Set<Class<?>> getClasses() {
        return new HashSet<>(Arrays.asList(
                ClientExceptionMappingTestServiceImpl.class,
                ContentNegotiationTestServiceImpl.class,
                CookieParamTestServiceImpl.class,
                CustomTypeTestServiceImpl.class,
                HeaderParamTestServiceImpl.class,
                InterceptedCallTestServiceImpl.class,
                InterceptsRemoteCallTestServiceImpl.class,
                JacksonTestServiceImpl.class,
                JaxrsResponseObjectTestServiceImpl.class,
                ...
                CustomMarshallerServiceImpl.class
        ));
    }
}
