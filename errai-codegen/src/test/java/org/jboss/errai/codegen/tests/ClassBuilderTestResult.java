...
public interface ClassBuilderTestResult {
  ...
  public static final String CLASS_WITH_COLLIDING_IMPORTS_WITH_INNER_CLASS =
      "     package my.test;" +
          ...
          "   org.jboss.errai.codegen.tests.ClassBuilderTest.TestInterface, Serializable {\n" +
          "   private String name;\n" +
          " }";
  ...
  public static final String CLASS_WITH_COLLIDING_IMPORTS_WITH_INNER_CLASS_FIRST =
      "     package my.test;" +
          "\n" +
          " import java.io.Serializable;\n" +
          " import org.jboss.errai.codegen.tests.ClassBuilderTest.TestInterface;\n" +
          "\n" +
          " public class Clazz implements TestInterface, " +
          "   org.jboss.errai.codegen.tests.model.TestInterface, Serializable {\n" +
          "   private String name;\n" +
          " }";

  public static final String CLASS_WITH_COLLIDING_IMPORTS_WITH_JAVA_LANG =
      "     package my.test;" +
          " import org.jboss.errai.codegen.tests.model.Integer;\n" +
          "\n" +
          " public class Clazz {\n " +
          "   private Integer i;\n" +
  ...
  public static final String CLASS_WITH_COLLIDING_IMPORTS_WITH_JAVA_LANG_FIRST =
      "     package my.test;" +
          ...
          " public class Clazz {\n " +
          "   private Integer i;\n" +
          "   private org.jboss.errai.codegen.tests.model.Integer j;\n" +
          " }";
}