package org.jboss.errai.codegen.framework.tests.gwt.rebind;
...
import org.jboss.errai.codegen.framework.tests.gwt.client.TestInterface;
import org.jboss.errai.codegen.framework.tests.gwt.client.TypeOracleBootstrap;
import org.jboss.errai.codegen.framework.tests.gwt.client.TypeWithNestedClass;
...
public class TypeOracleGenerator extends Generator {
  ...
  public String generate(TreeLogger logger, GeneratorContext context, String typeName) throws UnableToCompleteException {
    ...
    final String cls = "package " + packageName + ";\n" +
            "public class " + clazzName + " implements org.jboss.errai.codegen.framework.tests.gwt.client.TypeOracleBootstrap { }";
