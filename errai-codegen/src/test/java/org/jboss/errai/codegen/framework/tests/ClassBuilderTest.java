...
public class ClassBuilderTest extends AbstractCodegenTest implements ClassBuilderTestResult {
  ...
  public void testCollidingImportsWithInnerClass() {
    String cls = ClassBuilder.define("my.test.Clazz")
        .publicScope()
        .implementsInterface(org.jboss.errai.codegen.framework.tests.model.TestInterface.class)
  ...
  public void testCollidingImportsWithJavaLang() {
    String cls = ClassBuilder.define("my.test.Clazz")
        .publicScope()
        .body()
        .privateField("i", org.jboss.errai.codegen.framework.tests.model.Integer.class)
        .finish()
  ...
  public void testCollidingImportsWithJavaLangFirst() {
    String cls = ClassBuilder.define("my.test.Clazz")
        ...
        .finish()
        .privateField("j", org.jboss.errai.codegen.framework.tests.model.Integer.class)
        .finish()
        .toJavaString();
