...
import org.jboss.errai.codegen.tests.model.BeanWithTypeParmedMeths;
import org.jboss.errai.codegen.tests.model.Foo;
...
public class StatementBuilderTest extends AbstractCodegenTest {
  ...
  public void testTypeInferenceWorksPropertyForParameterizedMethodTypes() {
    ...
    assertEquals("org.jboss.errai.codegen.tests.model.BeanWithTypeParmedMeths.INSTANCE" +
            ".setFooBarMap(org.jboss.errai.codegen.tests.model.BeanWithTypeParmedMeths.INSTANCE.getFooBarMap())",
            s);
