...
import org.jboss.errai.codegen.tests.model.MyBean;
import org.jboss.errai.codegen.tests.model.MyTestAnnotation;
...
public class AnnotationEncoderTest extends AbstractCodegenTest {
  ...
  public void testEncodeAnnotationWithMultipleProperties() {
    ...
    assertEquals("new org.jboss.errai.codegen.tests.model.MyTestAnnotation() { " +
            "public Class annotationType() { " +
            "    return org.jboss.errai.codegen.tests.model.MyTestAnnotation.class; " +
            "} " +
            "public String foo() { " +
            "    return \"barfoo\"; " +
            "} " +
            "public org.jboss.errai.codegen.tests.model.TEnum testEum() { " +
            "    return org.jboss.errai.codegen.tests.model.TEnum.FOURTH; " +
            "} " +
            "public String toString() { " +
            "    return \"@org.jboss.errai.codegen.tests.model.MyTestAnnotation(foo=barfoo, testEum=FOURTH)\"; " +
            "} " +
            "}", enc);
  }
}