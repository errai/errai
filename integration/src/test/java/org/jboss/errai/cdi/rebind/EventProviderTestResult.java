...
public interface EventProviderTestResult {
  ...
  public static final String EVENT_PROVIDER_FOR_STRING_WITHOUT_QUALIFIERS = "(javax.enterprise.event.Event<java.lang.String>) "
      + " inj.provide(new Class[] {java.lang.String.class}, null)";

  public static final String EVENT_PROVIDER_FOR_STRING_WITH_QUALIFIERS = "(javax.enterprise.event.Event<java.lang.String>) "
