...
public class BoundAnnotationCheckerTest extends AbstractProcessorTest {
  ...
  public void shouldPrintErrorWhenBoundThingIsNotAWidget() throws FileNotFoundException {
    ...
    assertCompilationMessage(diagnostics, Kind.ERROR, 15, 24, "@Bound must target a type assignable to Widget or Element, or be a JsType element wrapper.");
    assertCompilationMessage(diagnostics, Kind.ERROR, 18, 18, "@Bound must target a type assignable to Widget or Element, or be a JsType element wrapper.");
    assertCompilationMessage(diagnostics, Kind.ERROR, 25, 46, "@Bound must target a type assignable to Widget or Element, or be a JsType element wrapper.");
    assertCompilationMessage(diagnostics, Kind.ERROR, 30, 45, "@Bound must target a type assignable to Widget or Element, or be a JsType element wrapper.");
    assertCompilationMessage(diagnostics, Kind.ERROR, 35, 18, "@Bound must target a type assignable to Widget or Element, or be a JsType element wrapper.");
  }
